...
plot(sub.tab$time,sub.tab$sub.metering.1,type='l',col='black',
     xlab="",ylab="Energy sub metering" )
lines(sub.tab$time,sub.tab$sub.metering.2,type='l',col='red')
lines(sub.tab$time,sub.tab$sub.metering.3,type='l',col='blue')
legend('topright',lty=1,col=c('black','red','blue'),
       legend=c('Sub_metering_1','Sub_metering_2','Sub_metering_3') )

plot(sub.tab$time,sub.tab$voltage,type='l',xlab='datetime',ylab='Voltage')

plot(sub.tab$time,sub.tab$global.reactive.power,type='l',xlab='datetime',ylab='Global_reactive_power')
